...
description: Use for this project when planning, revising, dispatching, or reviewing the UI prefab generation system. Enforces doc-zone ownership, subagent dispatch format, asmdef and directory isolation, migration boundaries, and Holmas trial-project constraints.
---
