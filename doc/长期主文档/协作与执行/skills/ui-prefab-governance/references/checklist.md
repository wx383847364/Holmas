# UI Prefab Governance Checklist

## Before Editing

- Is the authoritative doc path under `doc/长期主文档/UI自动生成系统`?
- Is there any duplicated正文 still left in `方案与数据`?
- Does this task affect dispatch, ownership, or migration boundaries?
