    ...
    public sealed class HolmasPlayerArchiveMapper
    {
        ...
        public HolmasMetaProgressionState RestoreProgression(HolmasPlayerArchiveRoot archive)
        {
            ...
            var state = new HolmasMetaProgressionState
            {
                ...
                AvatarIconPath = source.AvatarIconPath ?? string.Empty,
                CurrentDailyTaskIncome = Math.Max(0L, source.CurrentDailyTaskIncome),
                CurrentDailyPeriodKey = source.CurrentDailyPeriodKey ?? string.Empty,
                CurrentDailyTaskIncomeUpdatedAtUtcMilliseconds = Math.Max(0L, source.CurrentDailyTaskIncomeUpdatedAtUtcMilliseconds),
                CurrentWeeklyCatsFound = Math.Max(0, source.CurrentWeeklyCatsFound),
                CurrentWeeklyPeriodKey = source.CurrentWeeklyPeriodKey ?? string.Empty,
                CurrentWeeklyCatsFoundUpdatedAtUtcMilliseconds = Math.Max(0L, source.CurrentWeeklyCatsFoundUpdatedAtUtcMilliseconds),
                CurrentLevelRankUpdatedAtUtcMilliseconds = Math.Max(0L, source.CurrentLevelRankUpdatedAtUtcMilliseconds),
        ...
        private static HolmasProgressionArchiveData ExportProgression(HolmasMetaProgressionState state)
        {
            ...
            return new HolmasProgressionArchiveData
            {
                ...
                AvatarIconPath = state.AvatarIconPath ?? string.Empty,
                ...
                CurrentDailyTaskIncomeUpdatedAtUtcMilliseconds = Math.Max(0L, state.CurrentDailyTaskIncomeUpdatedAtUtcMilliseconds),
                ...
                CurrentWeeklyCatsFoundUpdatedAtUtcMilliseconds = Math.Max(0L, state.CurrentWeeklyCatsFoundUpdatedAtUtcMilliseconds),
                CurrentLevelRankUpdatedAtUtcMilliseconds = Math.Max(0L, state.CurrentLevelRankUpdatedAtUtcMilliseconds),
